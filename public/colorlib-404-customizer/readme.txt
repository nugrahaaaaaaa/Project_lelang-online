...
3. Upload the `colorlib-404-customizer` folder to the `/wp-content/plugins/` directory.
4. Activate the plugin through the 'Plugins' menu in WordPress.
5. A new sub menu item `Colorlib 404 Customizer` will appear in your main Settings menu.
